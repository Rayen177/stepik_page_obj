...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        ...
        assert 'login' in self.browser.current_url, 'You are not on logging page'
    ...
    def should_be_register_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.REGISTRATION_FROM), 'Registration form is absent'
